...
@api_v1_bp.get("/providers/<int:provider_id>/services")
...
@api_v1_bp.get("/providers/<int:provider_id>/services/<int:service_id>")
def get_provider_service(provider_id: int, service_id: int):
    db = get_db_session()
